...
def test_class_vacancy(test_list_hh):
    ...
    assert repr(vacancy_list) == ("[{'id': '115882074', 'name': 'Ученик на производство', 'area': 'Фрязино "
                                 "(Московская область)', 'salary_from': 0, 'url': "
                                 "('https://hh.ru/vacancy/115882074',), 'snippet_requirement': ('Образование "
                                 'не ниже средне-специального. Внимательность. Усидчивость. Готовность '
                                 "работать в сменном графике.',), 'snippet_responsibility': 'Образование не "
                                 ...
                                 "None, 'snippet_responsibility': None}]")
    ...
    assert vacancy_list[0].to_dict() == {'area': 'Фрязино (Московская область)',
                                     'id': '115882074',
    ...
    assert str(vacancy_list[0]) == ('ID: 115882074\n'
